<?php
    ...
    if ($ADMIN->fulltree) {
        ...
        $page->add(new admin_setting_heading('theme_garthdee/smart_alerts_title', get_string('smart_alerts_title', 'theme_garthdee'), ''));
        ...
        $page->add(new admin_setting_heading('theme_garthdee/course_alert_title', get_string('course_alert_title', 'theme_garthdee'), ''));
        ...
        $page->add(new admin_setting_heading('theme_garthdee/downtime_title', get_string('downtime_title', 'theme_garthdee'), ''));
        ...
        $page->add(new admin_setting_heading('theme_garthdee/general_notification_title', get_string('general_notification', 'theme_garthdee'), ''));
